<template>
    <div class="largeBall" :class="color[tag] || color[1]">
        ...
        <div class="ball-bg">
            ...
            <span v-if="tag===1" class="status-text">优质</span>
            <span v-else-if="tag===2" class="status-text">合格</span>
            <span v-else-if="tag===3" class="status-text">污染</span>
            <span v-else class="status-text">未知</span>
        </div>
    </div>
</template>
<script>
